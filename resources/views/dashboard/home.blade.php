...
@section('content')
                    ...
                    <div class="card-body pb-0">
                        ...
                        <div class="news">
                            <div class="post-item clearfix">
                                <h4><a href="#">Nisi laborum quisquam</a></h4>
                                <p>Quia animi delectus tempore deleniti tenetur explicabo perspiciatis quam...</p>
                            </div>
                            <div class="post-item clearfix">
                                <h4><a href="#">At magnam consequuntur</a></h4>
                                <p>Vel voluptatem sequi nam sit autem aut delectus expedita aspernatur...</p>
                            </div>
                            <div class="post-item clearfix">
                                <h4><a href="#">Voluptatum quos placeat</a></h4>
                                <p>Mollitia officia omnis maiores rerum quasi corporis quibusdam...</p>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            // Reports line chart
            if (document.querySelector('#reportsChart') && typeof ApexCharts !== 'undefined') {
            ...
            // Budget radar chart
            if (document.querySelector('#budgetChart') && typeof echarts !== 'undefined') {
